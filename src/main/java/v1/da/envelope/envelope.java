...
public class envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9175767205211937205L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"envelope\",\"namespace\":\"da.envelope\",\"fields\":[{\"name\":\"schema_id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public envelope(java.lang.CharSequence schema_id, java.lang.CharSequence name) {
   ...
   */
  public static v1.da.envelope.envelope.Builder newBuilder() {
    return new v1.da.envelope.envelope.Builder();
  }
   ...
   * @return A new envelope RecordBuilder
   */
  public static v1.da.envelope.envelope.Builder newBuilder(v1.da.envelope.envelope.Builder other) {
    if (other == null) {
      return new v1.da.envelope.envelope.Builder();
    } else {
      return new v1.da.envelope.envelope.Builder(other);
    }
  }
   ...
   * @return A new envelope RecordBuilder
   */
  public static v1.da.envelope.envelope.Builder newBuilder(v1.da.envelope.envelope other) {
    if (other == null) {
      return new v1.da.envelope.envelope.Builder();
    } else {
      return new v1.da.envelope.envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<envelope>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(v1.da.envelope.envelope.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(v1.da.envelope.envelope other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.schema_id)) {
        this.schema_id = data().deepCopy(fields()[0].schema(), other.schema_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public v1.da.envelope.envelope.Builder setSchemaId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public v1.da.envelope.envelope.Builder clearSchemaId() {
      schema_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public v1.da.envelope.envelope.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public v1.da.envelope.envelope.Builder clearName() {
      name = null;
